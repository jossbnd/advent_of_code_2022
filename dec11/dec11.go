...
func main() {
	input, _ := os.ReadFile("./input11.txt")
  ...
  Test: divisible by %d
	...
	fmt.Println("Part One Answer:", inspect(monkeys, 20, func(w int) int { return w / 3 }))
	fmt.Println("Part Two Answer:", inspect(monkeys, 10000, func(w int) int { return w % lcm }))
}
